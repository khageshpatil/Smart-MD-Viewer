/**
 * TaskModal Component
 * Full-featured modal for viewing and editing tasks
 */

import { useState, useEffect } from "react";
import { Task, TaskStatus, TaskType, GitHubPR, Project } from "@/lib/indexedDB";
...
import { X, Save, Trash2, Eye, Code, GitPullRequest, Plus, Github, FileText } from "lucide-react";
...
export const TaskModal = ({
  ...
  useEffect(() => {
    if (task) {
      ...
      setTags([...task.tags]);
      setLinkedPRs([...task.linkedPRs]);
    } else if (initialStatus || initialProjectId) {
      // New task with initial status/project
      setTitle("");
      setDescription("");
  ...
  }, [task, initialStatus, initialProjectId]);
      ...
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl max-h-[90vh] w-[95vw] sm:w-full flex flex-col">
          ...
          <div className="flex-1 overflow-hidden flex flex-col gap-4" onKeyDown={handleKeyDown}>
            ...
            {/* Linked Documents (Placeholder for Phase 5) */}
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Document linking will be available in Phase 5.
              </p>
            </div>
          ...
          <DialogFooter className="flex flex-col sm:flex-row justify-between gap-2">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              ...
              <Button onClick={handleSave} disabled={!title.trim() || !projectId || saving} className="flex-1 sm:flex-initial">
